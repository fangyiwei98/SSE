# dataset config
_base_ = [
    "../_base_/datasets/dg_loveda_urban2rural_1024x1024.py",
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        datasets=[
            dict(
                type={{_base_.loveda_rural_type}},
                data_root={{_base_.loveda_rural_root}},
                data_prefix=dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        datasets=[
            dict(
                type={{_base_.loveda_urban_type}},
                data_root={{_base_.loveda_urban_root}},
                data_prefix=dict(
