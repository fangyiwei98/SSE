...
def parse_args():
    ...
    parser.add_argument('--dataset_path', default=r'E:\dataset\ISPRS\DG\2_Ortho_RGB.zip', help='potsdam folder path')
    parser.add_argument('--tmp_dir', default=r'E:\dataset\ISPRS\DGtemp', help='path of the temporary directory')
    parser.add_argument('--out_dir', default=r'E:\dataset\ISPRS\DG', help='output path')
    parser.add_argument(
        '--clip_size',
        type=int,
