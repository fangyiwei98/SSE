...
def parse_args():
    ...
    parser.add_argument("--config", default='configs/dinov2/SSE_dinov2_mask2former_512x512_bs1x4.py', help="train config file path")
    parser.add_argument("--checkpoint", default='checkpoints/dinov2_rein_and_head.pth', help="rein and head checkpoint file")
    parser.add_argument("--backbone", help="backbone checkpoint file", default="dinov2_converted.pth")
    parser.add_argument(
        "--work-dir",
        help=(
